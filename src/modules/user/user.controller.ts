...
import { CreateUserRequestSwaggerDto, UpdateUserRequestSwaggerDto, UserResponseSwaggerDto } from './dto/swagger.dto';
import { userValidationSchema, updateUserValidationSchema } from './schema/user.schema';

import { ApiSuccess, ApiSuccessPaginated } from '../../helpers/swaggerDTOWrapper.helpers';
...
export class UserController {
  ...
  create(@Body(new ZodValidationPipe(userValidationSchema)) body: CreateUserDto) {
